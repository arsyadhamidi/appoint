...
@section('menuPelanggaranWaka', 'active')

@section('content')
    <div class="row mb-4">
        <div class="col-lg">
            <form action="{{ route('waka-pelanggaran.index') }}" method="GET">
                @csrf
                <div class="card">
                    <div class="card-body">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('waka-pelanggaran.generateexcel') }}" class="btn btn-primary" target="_blank">
    ...
    <script>
        $(function() {
            ...
            $('#selectedJurusan').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/waka-pelanggaran/jquerySiswaKelas",
                    data: {
    ...
    <script>
        $(function() {
            ...
            $('#selectedJenis').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/waka-pelanggaran/jqueryNamaPelanggaran",
                    data: {
                        id_jenis: id_jenis
                    },
                    cache: false,
