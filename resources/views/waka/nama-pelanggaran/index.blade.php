        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('waka-namapelanggaran.create') }}" class="btn btn-primary">
                        <i class="bx bx-plus"></i>
                        Tambahkan Nama Pelanggaran
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($nama as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->sanksi ?? '-' }}</td>
                                    <td>
                                        <form action="{{ route('waka-namapelanggaran.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('waka-namapelanggaran.edit', $data->id) }}"
