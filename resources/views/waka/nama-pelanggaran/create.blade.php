...
@section('menuNamaPelanggaranWaka', 'active')

@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('waka-namapelanggaran.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('waka-namapelanggaran.index') }}" class="btn btn-primary">
                            ...
                            <div class="col-lg">
                                    ...
                                    <select name="jenispelanggaran_id"
                                        ...
                                        @foreach ($jenis as $data)
                                            <option value="{{ $data->id }}"
                                                {{ old('jenispelanggaran_id') == $data->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="nama" class="form-control @error('nama') is-invalid @enderror" rows="5"
                                        placeholder="Masukan nama pelanggaran">{{ old('nama') }}</textarea>
                                    @error('nama')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="point" class="form-control @error('point') is-invalid @enderror" rows="5"
                                        placeholder="Masukan point pelanggaran">{{ old('point') }}</textarea>
                                    @error('point')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="sanksi" class="form-control @error('sanksi') is-invalid @enderror" rows="5"
                                        placeholder="Masukan sanksi pelanggaran">{{ old('sanksi') }}</textarea>
                                    @error('sanksi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
