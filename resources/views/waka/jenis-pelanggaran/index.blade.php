        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('waka-jenispelanggaran.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($jenis as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('waka-jenispelanggaran.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('waka-jenispelanggaran.edit', $data->id) }}"
