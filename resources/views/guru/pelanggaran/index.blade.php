        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('guru-pelanggaran.generateexcel') }}" class="btn btn-primary" target="_blank">
                        ...
                        <tbody>
                            @foreach ($pelanggarans as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('guru-pelanggaran.destroy', $data->id) }}" method="POST"
                                            class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('guru-pelanggaran.edit', $data->id) }}"
    ...
    <script>
        $(function() {
            ...
            $('#selectedJurusan').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/guru-pelanggaran/jquerySiswaKelas",
                    data: {
