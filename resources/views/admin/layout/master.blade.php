            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if (Auth()->user()->level_id == '1')
                        ...
                        <li class="menu-item @yield('menuDataMaster')">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item @yield('menuDataSiswa')">
                                    <a href="{{ route('data-siswa.index') }}" class="menu-link">
                        ...
                        <li class="menu-item @yield('menuDataPelanggaran')">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item @yield('menuDataNamaPelanggaran')">
                                    <a href="{{ route('data-namapelanggaran.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Nama Pelanggaran</div>
                                    </a>
                                </li>
                                <li class="menu-item @yield('menuPelanggaran')">
                                    <a href="{{ route('data-pelanggaran.index') }}" class="menu-link">
                                        <div data-i18n="Without menu">Data Pelanggaran</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    @elseif(Auth()->user()->level_id == '3')
                        {{-- Biodata --}}
                        <li class="menu-item @yield('menuBiodataGuru')">
                            <a href="{{ route('biodata-guru.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-user"></i>
                                <div data-i18n="Analytics">Biodata Diri</div>
                            </a>
                        </li>
                        {{-- Pelanggaran --}}
                        <li class="menu-item @yield('menuPelanggaranGuru')">
                            <a href="{{ route('guru-pelanggaran.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-book"></i>
                                <div data-i18n="Analytics">Pelanggaran</div>
                            </a>
                        </li>
                    @elseif(Auth()->user()->level_id == '4')
                        {{-- Jenis Pelanggaran --}}
                        <li class="menu-item @yield('menuJenisPelanggaranWaka')">
                            <a href="{{ route('waka-jenispelanggaran.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-file"></i>
                                <div data-i18n="Analytics">Jenis Pelanggaran</div>
                            </a>
                        </li>
                        {{-- Jenis Pelanggaran --}}
                        <li class="menu-item @yield('menuNamaPelanggaranWaka')">
                            <a href="{{ route('waka-namapelanggaran.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-table"></i>
                                <div data-i18n="Analytics">Nama Pelanggaran</div>
                            </a>
                        </li>
                        {{-- Pelanggaran --}}
                        <li class="menu-item @yield('menuPelanggaranWaka')">
                            <a href="{{ route('waka-pelanggaran.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-book"></i>
                                <div data-i18n="Analytics">Pelanggaran</div>
                            </a>
                        </li>
                    @elseif(Auth()->user()->level_id == '5')
                        {{-- Pelanggaran --}}
                        <li class="menu-item @yield('menuPelanggaranKepala')">
                            <a href="{{ route('kepala-pelanggaran.index') }}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-book"></i>
                                <div data-i18n="Analytics">Pelanggaran</div>
                            </a>
                        </li>
