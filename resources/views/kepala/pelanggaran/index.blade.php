...
@section('menuPelanggaranKepala', 'active')

@section('content')
    <div class="row mb-4">
        <div class="col-lg">
            <form action="{{ route('kepala-pelanggaran.index') }}" method="GET">
                @csrf
                <div class="card">
                    <div class="card-body">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('kepala-pelanggaran.generateexcel') }}" class="btn btn-primary" target="_blank">
    ...
    <script>
        $(function() {
            ...
            $('#selectedJurusan').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/kepala-pelanggaran/jquerySiswaKelas",
                    data: {
    ...
    <script>
        $(function() {
            ...
            $('#selectedJenis').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/kepala-pelanggaran/jqueryNamaPelanggaran",
                    data: {
                        id_jenis: id_jenis
                    },
                    cache: false,
